...
- What is the importance of descriptive statistics in data analysis?
- What are the main goals of the three statistical approaches to data analysis?
```
...
# Packages
pacman::p_load(TBDBr, janitor, skimr, effectsize)
```
...
knitr::include_graphics("images/04-approaching-analysis/Informational-values.png")
```
...
```{r datives-overview, echo=FALSE}
datives <- languageR::dativeSimplified # get simplified datives from LanguageR package
datives %>% 
  slice_head(n =10) %>% 
  kable(booktabs = TRUE,
        caption = 'First 10 observations of the Datives dataset for demonstration.')
```
...
knitr::include_graphics("images/04-approaching-analysis/skew.png")
```
