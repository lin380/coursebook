...
```{r ad-auth-setup-rtweet, eval=FALSE}
auth_setup_default() # setup twitter credentials to work with rtweet

# ?
# try out rtweet authentication with RStudio Cloud to get first-time process view

```

```{r ad-auth-get, eval=FALSE}
auth_get()
```


```{r ad-get-followers, eval=FALSE}
