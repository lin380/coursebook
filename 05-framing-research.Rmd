...
- Directories represent semantic distinctions
- Files represent
  - Code files, individual steps in the preparation, analysis, and reporting 
    - Should not depend on the other files (packages, data, functions, objects, etc.)
  - Data files, represent the data at different stages in the research
    - Original data should not be modified
    - Derived data should be the necessary output to feed the next input step in the research
- Tie your files together (`_pipeline.R`)
- Document everything
  - README
    - describe the project in general terms including the purpose of the project, data sources, analysis methods, and other relevant information to help clarify how to reproduce the research with these project files.
  - Data dictionaries
    - ...
  - Code comments
  - Environment information (OS/ R version/ packages and versions)
  - Reproducibility instructions


```{r fr-project-template-tree, echo=FALSE}
fs::dir_tree("../project_template/")
```
