...
```{r pinboard-journals-linguistics, echo=FALSE, cache=FALSE}
readRDS("resources/journals_linguistics.rds") %>% 
  kable(caption = "A list of some linguistics journals.")
```

```{r pinboard-journals-humanities, echo=FALSE, cache=FALSE}
readRDS("resources/journals_humanities.rds") %>% 
  kable(caption = "A list of some humanities journals.")
```

```{r pinboard-journals-cl, echo=FALSE, cache=FALSE}
readRDS("resources/journals_cl.rds") %>% 
  kable(caption = "A list of some computational linguistics journals.")
```
...
```{r framing-research-visual-summary-graphic, echo=FALSE, fig.cap='Framing research: visual summary'}
knitr::include_graphics("images/05-framing-research/framing-research-visual-summary.png")
```
