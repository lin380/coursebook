...
At this point let me bring some terms that have been floating around in the world into our discussion that will helps us place text analysis in context. Unless you've been hiding under a rock you most likely will have encountered the term "data science". This term and the associated work performed by data science practitioners appears to delineate something new. This is only partly correct. One the one hand data science is still science. Where data science differs is not in the systematic approach to deriving insight from a complex world but really in the emphasis on data; the quantities, the process to acquire it, and process it for analysis, in particular. *If you are like me learning about science in grade school, you may have visions of white coats, labs, and petri dishes. Modern science hasn't changed in concept, but the access to and the processes to manage data have. What once was large slices of experience pale in comparison to the access afforded to researchers in the 21st century.*



- data analysis to data science
  - beginnings (Bell Labs [@Chambers2020], )

<!-- Data science as a process... -->

@Donoho2017 suggests what is coined "Data Science" is really six sub-divisions: 
...
<!-- ?? wisdom hierarchy here? -->

@Rowley2007

```{r dikw-rowley-2007, fig.cap='The wisdom hierarchy, Rowley(2007)'}
knitr::include_graphics("images/02-introduction/Rowley-dikw.png")
```

  - data deluge (This growth is in larger part due to the overwhelming increase in the amount of machine readable data available, sometimes referred to as the 'data deluge'.)
  - skills

<!-- Data science skills.... -->

Data alone, however, is not enough. To turn data into insight it takes computing skills, knowledge of statistics, and domain expertise \@ref(fig:intro-data-science-venn). 
...
Whether in industry and academics there are ever fewer domains where quantitative data analysis has not made significant inroads. The science of data has now reached deep into all aspects of life where making sense of the world is sought. 
...
- Sports (Moneyball), outline the situation as it highlights the contrast with traditional forms of reason based on human experience versus data-driven approaches to produce novel insight. [@Lewis2004]

- ...and language applications


The nexus between these three areas has also produced some well-known language applications \@ref(fig:intro-language-applications). From the language-capable personal assistant applications, plagarism detection software, machine translation and search, tangible results of quantitative approaches to language are becoming standard fixtures in our lives. 
...
Empirical approaches to language study
