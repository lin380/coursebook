...
```{r intro-data-science-venn, echo=FALSE, fig.cap='Data Science Venn Diagram adapted from [Drew Conway](http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram).'}
knitr::include_graphics("images/02-introduction/data-science-venn-paper.png")
```
...
```{r dikw-modification-diki-notes}
