...
lastfm %>% # curated dataset
  slice_head(n = 5) %>% # first 5 observations
  knitr::kable(booktabs = TRUE, # print pretty table
               caption = "Sample lyrics from curated Last.fm dataset.") # add caption to the table
```



Table: (\#tab:cd-structure-lastfm-order-arrange)Sample lyrics from curated Last.fm dataset.
...
<img src="images/07-curate-data/cd-regex-101.png" alt="RegEx101." width="90%" />
<p class="caption">(\#fig:cd-regex-101-image)RegEx101.</p>
</div>
...
write_csv(sdac, file = "../data/derived/sdac/sdac_curated.csv")  # write sdac to disk and label as the curated dataset
```
...
Table: (\#tab:cd-documentation-dic-starter-structure)Data dictionary starter structure for the SDAC curated dataset.
...
<img src="images/07-curate-data/cd-data-dictionary.png" width="90%" style="display: block; margin: auto;" />
